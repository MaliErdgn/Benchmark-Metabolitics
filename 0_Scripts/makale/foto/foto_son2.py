...
# =============================================================================
# 1. BIREYSEL GRAFIK URETIM FONKSIYONLARI
# =============================================================================
...
def generate_q1_parameter_sensitivity(df):
    print("Generating Parameter Sensitivity Plot (4-Panel)...")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "Figure2_Parameter_Sensitivity_Combined.png"), dpi=300, bbox_inches='tight')
    plt.close()

# =============================================================================
# 2. KOMPOZIT FIGUR BIRLESTIRME FONKSIYONLARI
# =============================================================================
def combine_standard_2panel(image_paths, output_filename):
    print("Combining 2-Panel Figure...")
...
def combine_balanced_3panel(image_paths, output_filename):
    print("Combining 3-Panel Centered Figure...")
...
if __name__ == "__main__":
    ...
    # 2. Birlestirme islemleri
    rankings_paths = [
        os.path.join(OUTPUT_DIR, "Ranking_Raw_Q1.png"), 
        os.path.join(OUTPUT_DIR, "Ranking_Cleaned_Q1.png")
    ]
    combine_standard_2panel(rankings_paths, "Figure1_Rankings_Combined.png")

    heatmap_paths = [
        os.path.join(OUTPUT_DIR, "Heatmap_MLModel_vs_Density_Q1.png"), 
        os.path.join(OUTPUT_DIR, "Heatmap_InputType_vs_Resolution_Q1.png"), 
        os.path.join(OUTPUT_DIR, "Pareto_Frontier_Q1.png")
    ]
    combine_balanced_3panel(heatmap_paths, "Figure3_Heatmap_Pareto_Combined.png")
    
    print(f"Process completed. All individual and combined figures are saved in: {OUTPUT_DIR}")